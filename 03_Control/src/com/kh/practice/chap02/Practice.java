...
public class Practice {
	...
	public void method2() {
		// 1 ~ 10까지 총 합을 구하여 출력
		/*
		 * total = 0 1 + 2 + 3 + 4 + ... + 9 + 10 (((1 + 2) + 3) + 4) + 5 ...
		 * 
		 * total = total + i // => total = 0 + 1 = 1 // => total = (0 + 1) + 2 = 3 // =>
		 * total = ((0 + 1) + 2) + 3
		 */
		int total = 0;
		for (int i = 1; i <= 10; i++) {
	...
	public void method3() {
		 ...
		 * Math.random() 값의 범위 : 0.0 ~ 0.99999xx (0.0 <= n < 1.0) * 10 => 0.0 ~ 9.999999
		 * 10 + 1 => 1.0 ~ 10.9999 (int)(*10+1) => 1 ~ 10 => 1 ~ 10 사이의 랜덤값 :
